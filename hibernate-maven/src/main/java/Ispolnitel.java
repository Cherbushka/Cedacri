...
public class Ispolnitel {
	...
	public Ispolnitel(int Cod_ispolnitelia, String FIO_ispolnitelia, String Grajdanstvo, char Pol, Date Data_rojdenia) { 
		this.setCod_ispolnitelia(Cod_ispolnitelia);
